...
cp files/config.sh cdk/src/config.sh

cp files/cdk.ts cdk/bin/cdk.ts

rm -rf cdk/lib/*

cp files/ec2-cdk-stack.ts cdk/lib/ec2-cdk-stack.ts
mkdir -p cdk/lambda

cp files/lambda_function.py cdk/lambda/lambda_function.py
cd cdk
npm run build
cdk deploy
